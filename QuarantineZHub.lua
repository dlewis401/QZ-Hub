...
loadstring(game:HttpGet("https://raw.githubusercontent.com/dlewis401/QZ-Hub/main/Key-System.lua"))()

-- UI SCRIPT 

local Quarantine_Z_Hub = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Main_Window = Quarantine_Z_Hub.CreateLib("N3UR0515 Hub", "Serpent")

-- CREDITS SECTION 
local Credits_Tab = Main_Window:NewTab("Credits")
local Credits_Section = Credits_Tab:NewSection("N3UR0515 Hub Credits")
Credits_Section:NewLabel("Credits to Lynette")
Credits_Section:NewLabel("Need Support? Join here: DISCORD LINK")

-- Player Section
local Player_Tab = Main_Window:NewTab("Player")
...
__index = hookmetamethod(game, "__index", function(t, k)
    -- // Make sure the exploit is making this call
    if (checkcaller()) then
        -- // Make sure we are trying to get a player's character
        if (k == "Character" and t.Parent == Players) then
            -- // Vars
            local PlayerData = PlayerList[t]

            -- // Return the data
            return PlayerData and PlayerData.Character or nil
        end
    end
...
Misc_Section:NewButton("Full Bright", "Enables Full Bright", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/06iG6YkU", true))()
end)
Misc_Section:NewButton("Private / Grind Server", "Puts you in a Private Server", function()
